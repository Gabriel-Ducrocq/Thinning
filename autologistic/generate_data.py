import numpy as np
from autologistic import utils_autologistic
import argparse
...
parser.add_argument("vertex_number", help="number of points on the map")
...
y = utils_autologistic.run_gibbs(y.copy(), alpha, beta, neighbour_matrix, n_iter=n_gibbs, history=False)
